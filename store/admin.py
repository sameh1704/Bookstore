...
from .models import Stage, ClassLevel, Classroom, Student, Book, Supplier, BookDistribution , AcademicYear , SchoolBooklet , SchoolSupplies , StockReport
...
class NotebookTypeAdmin(admin.ModelAdmin):
    list_display = ['name', 'description', 'source', 'supplier', 'in_quantity', 'live_quantity', 'term', 'received_date', 'size']
    list_filter = ['source', 'term', 'received_date']
    search_fields = ['name', 'description', 'size']

class NotebookAssignmentAdmin(admin.ModelAdmin):
    list_display = ['grade', 'notebook', 'quantity_assignment', 'year', 'assigned_date']
...
class StockReportAdmin(admin.ModelAdmin):
    list_display = ('stage', 'class_level', 'academic_year', 'term', 'report_date')
    list_filter = ('stage', 'class_level', 'academic_year', 'term', 'report_date')
